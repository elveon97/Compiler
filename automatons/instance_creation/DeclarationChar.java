...
public class DeclarationChar {
  public static void main(String[] args) {
    ...
    io.serialization.Serializer.serialize(automaton, "automatons/serialized/DeclarationChar.ser");
  }
}
