...
public class AssignationChar {
  public static void main(String[] args) {
    ...
    Transition t3 = new Transition(lexeme.Matcher.CHAR, n4);
    ...
    io.serialization.Serializer.serialize(automaton, "automatons/serialized/AssignationChar.ser");
  }
}
