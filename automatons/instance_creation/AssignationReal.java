...
public class AssignationReal {
  public static void main(String[] args) {
    ...
    Transition t3 = new Transition(lexeme.Matcher.REAL, n4);
    ...
    io.serialization.Serializer.serialize(automaton, "automatons/serialized/AssignationReal.ser");
  }
}
